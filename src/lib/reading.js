...
//
// Three is the shortlist. It fits beside the finding it belongs to, it is
// short enough to be read in the room, and the order is the library's own
// sort_order — so which three is an editorial decision made in Settings →
// Resources rather than an accident of insertion order.
export const MAX_READING_PER_ACTIVITY = 3;
