...
**A four-option scale, where the document asked for five.** Every rating scale in this app has four options and no midpoint, which forces a lean: Inconsistent or Good, Usually or Rarely. A five-point scale offers "Sometimes", and on a self-assessment about somebody's own professionalism that is where a defensive answer parks — fifteen of them produce a flat profile with no strongest area, no leverage opportunity, and nothing to talk about.
