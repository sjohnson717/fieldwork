...
- **Apply source never overwrites a library resource.** For an article already in Library → Resources, the seeder sets only its address (the /reading/ policy) and merges in its question links, filling the note and author only when they are blank. Title, type, order, fallback, and active stay as the library set them, so an article switched off there stays off. A new article gets every field.
