...
| \`src/lib/reading.js\` | How much reading one activity may carry on a report: three, taken in the library's own \`sort_order\`. Both report surfaces that list reading \u2014 the instrument self-summary and the personal profile's shortlist \u2014 go through \`capReading\`. |
