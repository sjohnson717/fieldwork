...
| Route | Purpose |
|---|---|
| \`/admin\` | Everything the facilitator does. Assessment list, setup, results, discussion, instruments, library, tags, organizations, facilitators. The only route behind \`ProtectedRoute\`. |
