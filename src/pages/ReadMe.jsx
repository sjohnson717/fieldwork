...
- **Commit everything is the routine when the editing is done in the app.** One button beside Sync, one commit, every file whose app copy differs from its file — the subject names what changed and the body lists the paths. The per-row Commit stays, because one row at a time is the right shape for deciding about a difference; it is the wrong shape for an ordinary afternoon, where keeping the repository current was four syncs and four commits and so got skipped. There is deliberately no Apply everything: applying overwrites what somebody typed into the app, and that is decided one file at a time after reading what changes.
