...
- **Reading lives at two addresses, and only one is the seed's.** Blog articles point at \`/reading/<slug>\`, the CTA-free copy the seed composes from \`ARTICLE_PREFIX\`. The 23 chaos limericks point at the Wix dynamic page \`/i/<slug>\`, were added in the app, and are unknown to the seed, so Apply source leaves them alone. Their slugs don't always follow the title: Choose Your Own Adventure is \`write-your-own-adventure\`, and an apostrophe stays in the slug (\`who%27s-on-first\`). Wix's \`dynamic-i_…-sitemap.xml\` lists the real ones.
