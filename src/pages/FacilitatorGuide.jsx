...
- **The client dropdown** shows one client's assessments, with a line adding up that client's work — how many assessments, how many people have finished, and how many are part way through. It lists each **Client company** with its count and appears once you have more than one client. Names are matched ignoring capitals and spaces, so "Public" and "public" are one client, but "Alert Media" and "AlertMedia" are two — fix the spelling on the assessment's Overview tab if you see a near-duplicate. The client you picked stays chosen when you open one of its assessments and come back.
