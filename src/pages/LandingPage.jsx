  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4 py-10 text-center">
        <div className="bg-white/90 backdrop-blur-md border border-gray-200/60 rounded-2xl p-10 shadow-2xl">
          <img
          ...
          {!isAuthenticated ? (
            ...
            <>
              ...
              <p className="text-gray-500 text-sm mb-8">
                You're logged in. Use your assessment code to participate in a Quartz Assessment.
              </p>
              <Link
                to="/assess"
