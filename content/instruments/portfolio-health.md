...
## Dimension: What would you do?
id: what-would-you-do

## Question: Project versus product
id: project-versus-product
section: Challenges
required: yes

My team is confused about the difference between a project and a product.
...
**Reading.**
- [Project Management Isn’t Product Management](project-management-isn-t-product-management)
...
My team is unsure about what we should build and what we should avoid.
...
**Reading.**
- [You Can’t Have Everything: Three Keys to Successful Products](you-can-t-have-everything-three-keys-to-successful-products)

## Question: Too many ideas
id: too-many-ideas
section: Challenges
required: yes

We have too many ideas and don’t know which to choose.
...
**Reading.**
- [Prioritization using IDEAS](prioritization-using-idea)

## Question: Too many products
id: too-many-products
section: Challenges
required: yes

We have too many products and want to keep the best and retire the rest.
...
Our lack of vision has been embarrassing in front of leadership and customers.
...
**Reading.**
- [Defining Your Product Vision](defining-your-product-vision-the-foundation-for-strategy-roadmaps-and-success)
...
We just acquired our biggest competitor. Now we have duplicate products and are struggling to rationalize the portfolio.
...
We rarely say “no” to new product or feature ideas from customers, executives, salespeople, and others.
...
**Reading.**
- [Stop Asking for Features: Start Hunting for Problems](stop-asking-for-features-start-hunting-for-problems)
...
If you had an extra $1,000,000, where would you put it?
...
**Reading.**
- [Strategic Investment in Product Management: The Time is Now](the-case-for-the-strategic-investment-in-product-management)
